...
{
    public class BirdsPianoBinder : IPianoStatisticBinder, IDisposable
    {
        ...
        public BirdsPianoBinder(PianoKeyPressStatistics statistics, BoidsGravityPoints boidsGravityPoints, BoidsPianoBindConfig boidsPianoBindConfig)
        {
