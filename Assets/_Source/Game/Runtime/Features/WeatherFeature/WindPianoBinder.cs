...
{
    public class WindPianoBinder : PianoWeatherBinder
    {
        private readonly WeatherTween _windForceTween;
        private readonly WeatherTween _windDirectionTween;
        
        public WindPianoBinder(PianoKeyPressStatistics statistics, WeatherTweener weatherTweener, WeatherPianoBindConfig weatherPianoBindConfig) : base(statistics, weatherTweener, weatherPianoBindConfig)
        {
