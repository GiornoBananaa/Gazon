...
using Game.Runtime.MusicInstrumentFeature.Animations;
...
namespace Game.Runtime.MusicInstrumentFeature
{
    public class InstrumentPlayerInteraction : MonoBehaviour, IInteractable
    {
        ...
        [SerializeField] private HandsInstrumentAnimation _handsInstrumentAnimation;
        ...
        private void TakeSeat()
        {
            ...
            if(_handsInstrumentAnimation)
                _handsInstrumentAnimation.Enable();
        }
        ...
        private void GetUp()
        {
            ...
            if(_handsInstrumentAnimation)
                _handsInstrumentAnimation.Disable();
        }
    }
}